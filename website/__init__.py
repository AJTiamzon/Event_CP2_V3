...
def setup_admin(app):
    ...
    from .models import Users9, Events16, Attendee_events8, Event_records7, Client_Attend_Events2, Client_Hired_Suppliers5, SupplierRating3
    ...
    admin.add_view(RestrictedModelView(Event_records7, db.session))
